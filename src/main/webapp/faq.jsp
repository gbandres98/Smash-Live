	...
	<nav class="navbar navbar-fixed-top navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp">Smash Live</a>
			</div>
	...
	<div id="top" class="container">
		...
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="col-xs-12 col-sm-9">
				<div class="jumbotron">
					<h1>Hello, world!</h1>
					<p>Aquí aparecerá el FAQ de Smash Live, con explicaciones para
						utilizar sus diferentes componentes</p>
				</div>
				<div class="row">
					<div id="p1" class="col-xs-6 col-lg-12">
						...
						<p>
							<a class="btn btn-default" href="#top" role="button">Back to
								top &raquo;</a>
						</p>
					</div>
					<!--/.col-xs-6.col-lg-12-->
		...
		<footer>
			<p>&copy; AISS 2016/17 - Smash Live</p>
		</footer>
